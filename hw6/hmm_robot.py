...
for i in range(10):
    for j in range(10):
        lower_ul.append(float(0.7*dist(i,j,0,0)))
        lower_ur.append(float(0.7*dist(i,j,0,9)))
        lower_ll.append(float(0.7*dist(i,j,9,0)))
        lower_lr.append(float(0.7*dist(i,j,9,9)))
        upper_ul.append(float(1.3*dist(i,j,0,0)))
        upper_ur.append(float(1.3*dist(i,j,0,9)))
        upper_ll.append(float(1.3*dist(i,j,9,0)))
        upper_lr.append(float(1.3*dist(i,j,9,9)))
